...
import m1 from "./images/move (1).jpg";
import m2 from "./images/move (2).jpg";
import m3 from "./images/move (3).jpg";
import m4 from "./images/move (4).jpg";
import m5 from "./images/move (5).jpg";
import m6 from "./images/move (6).jpg";
import m7 from "./images/move (7).jpg";
import m8 from "./images/move (8).jpg";
import m9 from "./images/move (9).jpg";
import m10 from "./images/move (10).jpg";
import m11 from "./images/move (31).jpg";
import m12 from "./images/move (32).jpg";
import m13 from "./images/move (33).jpg";
...
const MovieRow2 = () => {
    ...
    return (
        <>
            <h3 className='move_type'>Trending Now</h3>
